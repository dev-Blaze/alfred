...
import com.yshah.aide.network.ConnectionTestResult
...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        topBar = { TopAppBar(title = { Text("Aide Settings") }) },
    ) { padding ->
        Column(
            modifier = Modifier
                .padding(padding)
...
private fun BatteryOptimizationRow() {
    ...
    Column {
        ...
        Text(
            text = if (isExempt) {
                "Aide is exempt — background delivery should survive Samsung's battery management."
            } else {
