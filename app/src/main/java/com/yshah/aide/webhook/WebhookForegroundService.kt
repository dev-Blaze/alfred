package com.yshah.aide.webhook
...
import com.yshah.aide.data.InteractionEntity
import com.yshah.aide.history.HistoryActivity
import com.yshah.aide.network.WebhookClient
import com.yshah.aide.network.WebhookResult
...
const val WEBHOOK_NOTIFICATION_CHANNEL_ID = "aide_webhook_channel"
...
class WebhookForegroundService : Service() {
    ...
    companion object {
        private const val ACTION_SEND_TASK_OR_NOTE = "com.yshah.aide.action.SEND_TASK_OR_NOTE"
    ...
    private fun buildRunningNotification(): Notification =
        NotificationCompat.Builder(this, WEBHOOK_NOTIFICATION_CHANNEL_ID)
            ...
            .setContentTitle("Sending to Aide")
            .setOngoing(true)
